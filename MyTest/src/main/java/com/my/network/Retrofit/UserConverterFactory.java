...
public class UserConverterFactory extends Converter.Factory {
    ...
    public class UserResponseConverter<T> implements Converter<ResponseBody, T> {
        ...
        public T convert(ResponseBody responseBody) throws IOException {
            ...
            // 对body进行AES+Base64解密
            String decrypt = Utils.resDecryptFromBody(result);
            T users = gson.fromJson(decrypt, type);
            return users;
        }
    }
    ...
    public class UserRequestBodyConverter<T> implements Converter<T, RequestBody> {
        ...
        public RequestBody convert(T value) throws IOException {
            ...
            // 对字符串进行AES+Base64加密
            String encrypt = Utils.resEncryptToBody(string);
            return RequestBody.create(MediaType.parse("text/plain; charset=UTF-8"), encrypt);
        }
    }
